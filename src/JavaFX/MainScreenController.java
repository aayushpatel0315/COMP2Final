...
public class MainScreenController {
	...
	private void initialize() {
		...
		// Customizing list cell appearance
		tasksListView.setCellFactory(lv -> new ListCell<Task>() {
			...
			protected void updateItem(Task item, boolean empty) {
				...
				if (empty || item == null) {
					...
					// Modify this to display any specific field of the Task object
					setText(item.toString());
					// Here you can set the style of each cell
					// For example, setting the text color:
					setStyle("-fx-text-fill: #bfa575;"); // ensures text color is visible against the background
				}
			}
		});
	}
